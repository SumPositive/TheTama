...
#define CAMERA_FOV_DEGREE_INIT          (100.0f)		//100.0 (45.0f)
/** Camera FOV minimum value */
#define CAMERA_FOV_DEGREE_MIN           (30.0f)
/** Camera FOV maximum value */
#define CAMERA_FOV_DEGREE_MAX           (160.0f)	//160.0 (100.0f)  縮小MAX
...
#define SCALE_RATIO_TICK_EXPANSION      (1.02f)		//1.02 (1.05f)
/** Parameter for minimum width control */
#define SCALE_RATIO_TICK_REDUCTION      (0.98f)		//0.98 (0.95f)
